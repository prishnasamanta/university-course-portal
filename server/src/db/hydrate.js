...
export async function hydrateSqliteFromPostgres(sqliteDb) {
  ...
  try {
    ...
    const tables = ['users', 'programs', 'semesters', 'students', 'instructors', 'courses', 'sections', 'section_schedule_slots', 'enrollments', 'exam_registrations', 'assessment_components', 'marks', 'marks_revision_requests', 'instructor_teaching_preferences'];
